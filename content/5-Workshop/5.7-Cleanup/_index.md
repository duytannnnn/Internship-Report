...
1. [Delete API Gateway](5.7.1-RemoveAPIGateway/)

2. [Delete Lambda Functions](5.7.2-RemoveLambdaFunction/)

3. [Delete S3 Bucket](5.7.3-RemoveS3Bucket/)

4. [Delete DynamoDB Table](5.7.4-RemoveDynamoDB/)

5. [Delete Cognito User Pool](5.7.5-RemoveCognitoUserPool/)

6. [Delete Amplify Hosting App](5.7.6-RemoveAmplifyHosting/)

7. [Delete CloudWatch Log Groups](5.7.7-RemoveCloudWatch/)

8. [Delete IAM Roles and Policies](5.7.8-RemoveIAM/)

9. [Remove other optional resources if any](5.7.9-CheckRemainingResources/)
