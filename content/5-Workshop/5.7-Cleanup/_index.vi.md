...
1. [Xóa API Gateway](5.7.1-RemoveAPIGateway/)
2. [Xóa Lambda Functions](5.7.2-RemoveLambdaFunction/)
3. [Xóa S3 Bucket](5.7.3-RemoveS3Bucket/)
4. [Xóa DynamoDB Table](5.7.4-RemoveDynamoDB/)
5. [Xóa Cognito User Pool](5.7.5-RemoveCognitoUserPool/)
6. [Xóa Amplify Hosting App](5.7.6-RemoveAmplifyHosting/)
7. [Xóa CloudWatch Log Groups](5.7.7-RemoveCloudWatch/)
8. [Xóa IAM Roles và Policies](5.7.8-RemoveIAM/)
