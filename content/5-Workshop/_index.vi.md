...
2. [Thiết lập môi trường](5.2-Environmentsetup/)
3. [Xử lý hóa đơn bằng AI](5.3-AIpoweredinvoiceprocessing/)
4. [Triển khai API Gateway](5.4-Deployingapigateway/)
5. [Kiểm thử với Postman](5.5-Testwithpostman/)
6. [Triển khai Frontend](5.6-Deployingfrontend/)
