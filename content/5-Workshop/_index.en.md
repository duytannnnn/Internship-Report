...
1. [Introduction](5.1-Introduce/)
2. [Environment Setup](5.2-Environmentsetup/)
3. [AI-Powered Invoice Processing](5.3-AIpoweredinvoiceprocessing/)
4. [Deploying API Gateway](5.4-Deployingapigateway/)
5. [Test with Postman](5.5-Testwithpostman/)
6. [Deploying Frontend](5.6-Deployingfrontend/)
